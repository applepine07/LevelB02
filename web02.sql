...
CREATE TABLE `log` (
  ...
  `user` text COLLATE utf8mb4_unicode_520_ci DEFAULT NULL
...
(12, 'dddddddd', 'ddddddddddddddd', 1, 0, 1);
...
(3, '夾蛋吐司', 1, 0, 1),
(4, '咖啡', 1, 0, 1),
(5, '問題一：你最常做什麼運動來促進健康體能呢?', 0, 5, 1),
(6, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 5, 4, 1),
(7, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 5, 1, 1),
(8, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 5, 0, 1),
(9, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 5, 0, 1),
(10, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 1, 1),
(11, '1.增加罹患冠狀動脈心臟病及罹病死亡之風險。', 10, 0, 1),
(12, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 10, 0, 1),
(13, '3.孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 10, 0, 1),
(14, '4.長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 10, 0, 1),
(15, '5.以上皆是。', 10, 1, 1),
(16, NULL, NULL, 1, 1),
(17, NULL, NULL, 1, 1),
(18, NULL, NULL, 1, 1),
...
(23, '4小時', 20, 0, 1),
(24, '你知道怎麼交朋友嗎?', 0, 2, 1),
(25, '討厭的章魚把事情變單純了?', 24, 0, 1),
(26, '討厭的章魚把事情變複雜了?', 24, 1, 1),
(27, '知道', 24, 0, 1),
(28, '不知道', 24, 1, 1),
(29, '關於強與弱', 0, 0, 1),
(30, '每人看重的強不一樣', 29, 0, 1),
(31, '每人看重的弱不一樣', 29, 0, 1),
(32, '眼前的強不是強，你說的弱是什麼弱', 29, 0, 1),
(33, '什麼是真正的快樂?', 0, 0, 0),
(34, '心安理得衣食住不缺', 33, 0, 1),
(35, '身體健康吃得下睡得著', 33, 0, 1),
(36, '面對順逆境心態都平和', 33, 0, 1),
(37, '嗯……', 33, 0, 1),
(38, '你到底在生氣什麼?', 0, 0, 1),
(39, '我會藉由討厭自己希望喜歡自己一點', 38, 0, 1),
(40, '其實我不喜歡生氣', 38, 0, 1),
(41, '不知道', 38, 0, 1),
(42, '最喜歡的食物?', 0, 0, 1),
(43, '雞排', 42, 0, 1),
